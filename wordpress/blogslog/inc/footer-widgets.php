...
class BlogSlog_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'blogslog';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'blogslog' ), $i ),
...
// Initialize.
$blogslog_footer_widgets = new BlogSlog_Footer_Widgets();
