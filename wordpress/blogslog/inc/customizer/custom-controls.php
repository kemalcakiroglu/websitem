 ...
 */
class BlogSlog_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class BlogSlog_Dropdown_Category_Control extends WP_Customize_Control {
...
class BlogSlog_Note_Control extends WP_Customize_Control {
...
class BlogSlog_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class BlogSlog_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blogslog-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class BlogSlog_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class BlogSlog_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="blogslog-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="blogslog-sortable-input sortable-hideme" name="<?php echo esc_attr( $trimmed_value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $value ); ?> </span>
          <i class="dashicons dashicons-menu blogslog-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="blogslog-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
Class BlogSlog_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class BlogSlog_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
